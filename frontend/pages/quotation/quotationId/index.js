...
export default function QuotationId() {
  ...
  useEffect(() => {
    ...
    async function loadClient() {
      ...
      client && setMostrarCliente(client.id);
    }
    loadClient();
      ...
      {!loading ? (
        <div className="flex max-h-[90%] min-h-[90%] h-[90%] max-w-[60%] min-w-[60%] w-[60%] bg-[#0d0f10] fixed right-[10rem] top-[3rem] rounded-md flex-col items-center py-24 px-24 pb-12">
          <div className="min-h-[60%] max-h-[60%] h-[60%] w-[100%]">
            <h1 className="block font-medium text-2xl pb-4 text-left">
            ...
            >
              ...
              {errors.carName && (
                <span className="absolute right-[6rem] top-[8rem] after:ml-0.5 after:text-red-500 block font-medium mb-[20px]">
              ...
              />
              {errors.price && (
                <span className="absolute right-[6rem] top-[18rem] after:ml-0.5 after:text-red-500 block font-medium mb-[20px]">
                  Este campo es requerido
                </span>
              )}
